              ...
              <div className="max-w-6xl space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <Card className="shadow-card">
                    <CardContent className="p-4 text-center">
                      <div className="flex items-center justify-center w-12 h-12 gradient-primary rounded-lg mx-auto mb-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <Card className="opacity-60 shadow-card">
                      <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                ...
                {/* Setup CTA */}
                <Card className="gradient-lovable text-white shadow-elegant border-0">
